...
# encryption_box
encryption_box = mn.tkinter.Text(height = 12, width = 40, font = ("times", 16))
...
# decrption_box
decrption_box = mn.tkinter.Text(height = 12, width = 40, font = ("times", 16))
decrption_box.grid(row = 2, column = 2)
